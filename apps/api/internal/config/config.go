...
func Load() Config {
	...
	return Config{
		...
		R2AccountID:       env("CF_R2_ACCOUNT_ID", env("R2_ACCOUNT_ID", "")),
		R2AccessKeyID:     env("CF_R2_ACCESS_KEY_ID", env("R2_ACCESS_KEY_ID", "")),
		R2SecretAccessKey: env("CF_R2_SECRET_ACCESS_KEY", env("R2_SECRET_ACCESS_KEY", "")),
		R2BucketName:      env("CF_R2_BUCKET_NAME", env("R2_BUCKET_NAME", "")),
		R2PublicURL:       env("CF_R2_PUBLIC_URL", env("R2_PUBLIC_URL", "")),
